#define LOG_TAG "FIH/cvVideoLSFilter"
#define DEBUG_LEVEL                 0

#include "cvVideoLSFilter.h"
...
cvVideoLSFilter::
cvVideoLSFilter(int h, int w, int cpuNums)
{
    //MY_LOGD("+");
    ...
    _mCumulSum.create(w, h, CV_32SC2);
    _mLocalSum.create(w, h, CV_32SC2);
}
...
void
cvVideoLSFilter::
CalCumulDist_Rows(Mat& mOneChn, int radius) //One Channel
{
	Size sumSize;
